...
var toolHints = map[string]hints{
	...
	"ableton_clear_clip_notes":               {destructive: true, idempotent: true},
	"ableton_compare_ab_variation":           {},
	"ableton_compare_fx_bypass":              {},
	"ableton_create_audio_track":             {},
	"ableton_create_bass_variation":          {},
	"ableton_create_clip":                    {},
	"ableton_create_drum_variation":          {},
	...
	"ableton_get_clip_notes":                 {readOnly: true},
	...
	"ableton_humanize_clip":                  {destructive: true},
	...
	"ableton_set_clip_name":                  {idempotent: true},
